      ...
      <header className="h-16 border-b bg-white px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 relative">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown */}
            {showSendDropdown && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border py-1 z-50" role="menu">
                <button
                  type="button"
                  role="menuitem"
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-left text-sm hover:bg-gray-50 flex items-center gap-2"
                >
                  <Link2 className="w-4 h-4 text-gray-500" aria-hidden="true" />
                  Copiar link
                </button>
              </div>
            )}
          ...
          {showToast && (
            <div
              role="status"
              aria-live="polite"
              className="absolute top-full right-0 mt-2 bg-[var(--grass-green)] text-white px-4 py-2 rounded-md shadow-lg text-sm z-50 flex items-center gap-2"
            >
